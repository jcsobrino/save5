...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        log.setup(logLevel: XCGLogger.LogLevel.None, showLogLevel: true, showFileNames: true, showLineNumbers: true, writeToFile: nil)
        ...
        let iconAnimation = FAKIonIcons.chatboxIconWithSize(CGFloat(52))
        iconAnimation.addAttribute(NSForegroundColorAttributeName, value: UIColor.whiteColor())
        iconAnimation.drawingPositionAdjustment = UIOffsetMake(1, 2);
        
        self.mask = CALayer()
        self.mask!.contents = iconAnimation.imageWithSize(CGSize(width: 52,height: 52)).CGImage
