...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private ApiService apiService = ApiFactory.INSTANCE.getApi();
...
User u = new User();
        u.setEmail("sdasd");
        u.setImageCode("asdasd");
        u.setPassword("sfsdfsdfsd");
        u.setName("sdfsdfsd");
        u.save();
        List<User> listUsers = new Select().from(User.class).where("email = ?", "sdasd").and("password = ?","sfsdfsdfsd").execute();
...
*/
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            return apiService.login(mEmail, mPassword) != null;
